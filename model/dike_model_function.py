...
from model.funs_generate_network import get_network
...
class DikeNetwork:
    def __init__(self, num_planning_steps = 3):
        ...
        # load network
        G, dike_list, dike_branch, planning_steps = get_network(
            self.num_planning_steps
        )

        # Load hydrological statistics:
        self.A = pd.read_excel("./model/data/hydrology/werklijn_params.xlsx")
